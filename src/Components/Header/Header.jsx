                    ...
                    <div className='head_wraper'>
                        <div className='logo_container'>
                            <img
                                ...
                                onClick={() => navigate("/")}
                            />
                            <p className='head_9' style={{fontSize:"11px",textAlign:"center",whiteSpace:"nowrap",marginLeft:-20,marginRight:30,fontStyle:"italic"}}>Meeting your needs. Surpassing your expectations.</p>
                        </div>
