    ...
    <div className="founder-container">
      ...
      <div className="founder-content">
        ...
        <div className="founder-description">
          <p>Sandip Shah, the founder of Market Access Solutions (MKTXS), is an experienced pricing strategist and industry veteran with over 30 years of experience in the healthcare sector, including sales, in-line marketing, forecasting, and market access.</p>
